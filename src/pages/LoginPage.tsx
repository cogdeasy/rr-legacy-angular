    ...
    <div className="login-page">
      <section className="login-hero hero-gradient">
        ...
        <ul className="hero-points">
          <li><Icon>insights</Icon> Continuous EHM downlink from 8 managed engines</li>
          <li><Icon>engineering</Icon> Workscope planning with shop capacity awareness</li>
          <li><Icon>verified</Icon> Airworthiness evidence retained against every decision</li>
        </ul>
      </section>
      ...
      <section className="login-form-panel">
        <div className="form-card">
          ...
          <form onSubmit={onSubmit} noValidate>
            ...
            {errorMessage && (
              <p className="error-message">
                <Icon>error_outline</Icon>{errorMessage}
              </p>
            )}

            <button
              className="rr-button rr-button-flat pill-cta submit-button"
              type="submit"
              disabled={isLoading}
            >
          ...
          <p className="assist">
            Locked out? Contact the operations service desk on extension 4400.
          </p>
        </div>
      </section>
    </div>
